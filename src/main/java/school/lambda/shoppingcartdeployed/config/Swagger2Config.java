...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors
                .basePackage("school.lambda.shoppingcartdeployed"))
    ...
    {
        return new ApiInfoBuilder().title("Shopping cart Project")
            .description("Shopping cart Project")
            .contact(new Contact("Edgar Ethan Trevino",
                "http://www.lambdaschool.com",
                "edgar-trevino@lambdastudents.com"))
            .license("MIT")
            .licenseUrl("https://github.com/eet349/java-deployshoppingcart/blob/master/LICENSE")
            .version("1.0.0")
            .build();
    }
}